...
from .tipo_nl_ban_compensator import NODE_CLASS_MAPPINGS as TIPO_NL_BAN_MAPPINGS
from .tipo_nl_ban_compensator import NODE_DISPLAY_NAME_MAPPINGS as TIPO_NL_BAN_DISPLAY_MAPPINGS
