...
from .sd_prompt_saver_optimized_v2 import NODE_CLASS_MAPPINGS as SD_PROMPT_V2_MAPPINGS
from .sd_prompt_saver_optimized_v2 import NODE_DISPLAY_NAME_MAPPINGS as SD_PROMPT_V2_DISPLAY_MAPPINGS

from .lora_wildcard_generator_v3 import NODE_CLASS_MAPPINGS as LORA_V3_MAPPINGS
from .lora_wildcard_generator_v3 import NODE_DISPLAY_NAME_MAPPINGS as LORA_V3_DISPLAY_MAPPINGS
...
from .impact_wildcard_processor_title import NODE_CLASS_MAPPINGS as WILDCARD_TITLE_MAPPINGS
from .impact_wildcard_processor_title import NODE_DISPLAY_NAME_MAPPINGS as WILDCARD_TITLE_DISPLAY_MAPPINGS

from .tipo_nobin_custom import NODE_CLASS_MAPPINGS as TIPO_NOBIN_MAPPINGS
from .tipo_nobin_custom import NODE_DISPLAY_NAME_MAPPINGS as TIPO_NOBIN_DISPLAY_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **SEED_STEP_MAPPINGS,
    **SD_PROMPT_V2_MAPPINGS,
    **LORA_V3_MAPPINGS,
    **WILDCARD_SEED_MAPPINGS,
    **WILDCARD_TITLE_MAPPINGS,
    **TIPO_NOBIN_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **SD_PROMPT_V2_DISPLAY_MAPPINGS,
    **LORA_V3_DISPLAY_MAPPINGS,
    **WILDCARD_SEED_DISPLAY_MAPPINGS,
    **WILDCARD_TITLE_DISPLAY_MAPPINGS,
    **TIPO_NOBIN_DISPLAY_MAPPINGS,
}
